...
- Handle the Nonsense value and transfer them in some value in order to make computer to read it:![PCA](https://github.com/Adouken133/final_project/blob/master/FIGURE/unique_of_email.png)
